...
For equity-sensitive deployments, EquiBandit reduces the topic-exposure Gini coefficient from $0.449$ to $0.101$ at $K{=}20$ with only a $-1.7\%$ knowledge loss, demonstrating that fairness and efficiency need not be in fundamental conflict.
