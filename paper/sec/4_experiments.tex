...
We compare 14 algorithms: Random, UCB1, Thompson Sampling, $\varepsilon$-Greedy, SW-UCB, Leitner, Greedy-Min, F-UCB, BKT-Bandit, PD-Whittle, Adapt-Whittle, Whittle (basic), MetaSelector, and a Decay-UCB variant.
...
BKT-Bandit maintains the strongest relative performance across all scales, while Greedy-Min's disadvantage grows with $K$.
...
On ASSISTments (moderate decay), BKT-Bandit and PD-Whittle maintain their advantage, and the Greedy-Min catastrophe manifests clearly.
