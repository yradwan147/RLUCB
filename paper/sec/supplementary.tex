...
BKT-Bandit achieves the best average rank (2.17) and the most top-3 finishes (10/12), making it the single most reliable algorithm.
F-UCB ranks second with 2 wins but is less consistent across regimes.
MetaSelector achieves top-3 at every $K{\geq}50$ configuration and top-5 in 8/12 overall, making it the safest default choice.
...
At $K{=}20$, $\lambda{=}0.01$, most algorithms remain equitable (Gini $<0.03$), but BKT-Bandit concentrates heavily on a subset of categories (Gini $= 0.447$, ``very unequal''), confirming its equity--efficiency trade-off.
