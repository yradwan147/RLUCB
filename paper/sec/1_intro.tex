...
\begin{enumerate}[leftmargin=*,itemsep=1pt,topsep=2pt]
  \item \textbf{RMAB formulation.} We extend RMAB-based approaches~\citep{mate2024eduqate,reddy2016unbounded} to a comprehensive quizzing benchmark with Ebbinghaus forgetting dynamics, providing a principled framework that exposes why stationary methods fail.
