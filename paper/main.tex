...
\begin{itemize}
  ...
  \item[] Justification: All claims are supported by experiments in Section~\ref{sec:experiments}. Performance numbers are reported with standard errors across 3--10 random seeds (10 for key configurations $K\in\{6,20\}$, 3 for $K\in\{50,100\}$).
\end{itemize}
...
\begin{itemize}
  ...
  \item[] Answer: \answerYes{}
  \item[] Justification: Theorems~1--4 include proof sketches in Section~\ref{sec:theory} and full proofs in Appendix~\ref{app:proofs}. Theorem~1 states explicit conditions; Theorems~2--3 state regret bounds; Theorem~4 proves a minimax lower bound via reduction.
\end{itemize}
...
\begin{itemize}
  ...
  \item[] Answer: \answerYes{}
  \item[] Justification: Standard errors across 3--10 random seeds (10 for key configurations $K\in\{6,20\}$, 3 for $K\in\{50,100\}$) are reported for all experiments.
\end{itemize}
...
\begin{itemize}
  ...
  \item[] Answer: \answerYes{}
  \item[] Justification: Broader impacts are implicitly discussed through the educational application context. The work targets improving personalized learning; potential risks include over-reliance on automated tutoring and equity concerns if adaptive systems amplify existing disparities.
\end{itemize}
